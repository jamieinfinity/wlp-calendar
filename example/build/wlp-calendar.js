...
function updateGridDays(daysData, monthPathData, updateSelectedDateSpan) {
    ...
    daySquares.enter().append("rect")
        ...
        .merge(daySquares)
        .attr("fill", d => {
            // return d.measurement ? colorMap((d.measurement - measurementData['measurementMinimum']) / (measurementData['measurementMaximum'] - measurementData['measurementMinimum'])) : "#ccc";
